const WIDGETS_DATA = [
  ...
  },
  {
    ...
    events: [
      ...
      { id: "msg2", label: "Bark Chat 2", listener: "chat-message", data: { name: "Shiba_Inu", message: "Cozy stream vibes! ðŸ¾ðŸ¶", badges: ["subscriber"] } },
  ...
  },
  {
    ...
    image: `<svg xmlns="http://www.w3.org/2000/svg" width="300" height="180" viewBox="0 0 300 180"><rect width="300" height="180" fill="%230c0d14"/><rect x="35" y="75" width="210" height="12" rx="6" fill="rgba(255,255,255,0.06)"/><rect x="35" y="75" width="130" height="12" rx="6" fill="%23e5a93b"/><text x="145" y="70" font-size="20">ðŸ¶</text><text x="245" y="87" font-size="18">ðŸ¦´</text><text x="150" y="116" fill="%23fff" font-family="'Outfit', sans-serif" font-weight="bold" font-size="13" text-anchor="middle">Treat Goal: 120 / 200</text></svg>`,
    events: [
  ...
  },
  {
    ...
    events: [
      ...
      { id: "newCheer", label: "Cheer Alert (100 bits)", listener: "cheer-latest", data: { name: "BitsCheerer", amount: 100 } }
    ]
  }
];
